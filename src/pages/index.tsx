  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-xs flex justify-center text-center mt-2 gap-1 items-center">Copyright © 2025 - Powered by <a href="https://fluently.io" target="_blank" className="text-brand">Fluently</a></p>
      </div>
    </div>
  );
}