...
export function InstallmentsDialog({ children, userId }: InstallmentsDialogProps) {
  ...
  const fetchInstallments = async () => {
    try {
      const response = await fetch(`https://v5.destinify.com.br/api/payment/get-installments/${userId}`)
  ...
  const handlePayment = async (installmentId: number) => {
    ...
    try {
      const response = await fetch(`https://v5.destinify.com.br/api/payment/${installmentId}/status`, {
        method: 'PATCH',
        headers: {
